        ...
        <header className="text-white body-font text-shadow-xl ">
            <div className="container  mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <Link href="/"><a className="flex title-font font-medium items-center  mb-4 md:mb-0 " href="/">
                    ...
                    <span className="ml-3 text-3xl">MY WORLD</span>
                </a></Link>

                <nav className="md:ml-auto  flex flex-wrap items-center justify-center  text-lg ">

                    <Link href="/room1"><a target="_blank" rel="noopener noreferrer" className=" mx-3 px-3 my-1 pb-1 bg-green-900 rounded 
                        hover:bg-green-700 ">Room 1
                    </a></Link>

                    <Link href="/room2"><a target="_blank" rel="noopener noreferrer" className=" mx-3 px-3 my-1 pb-1 bg-green-900 rounded 
