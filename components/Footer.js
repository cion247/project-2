...
const Footer = () => {
    return (
        <footer class="text-gray-400 bg-transparent body-font">
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row ">
                <a class="flex title-font font-medium items-center justify-start ">

                    <Image src="/earth.png" alt="..." width='50' height='40' objectFit='contain'
                        class="ml-3 rounded align-center" />
                </a>
                <p class="text-sm sm:ml-4 sm:pl-4 sm:border-l-2  sm:py-2 sm:mt-0 mt-4">twitter —
