        ...
        <section class="text-white text-shadow-xl bg-transparent body-font justify-center">
            <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                <div class="flex flex-wrap md:-m-2 -m-1 justify-center">
                    <div class=" p-1 w-1/2 md:w-3/4 2xl:w-full ">
            ...
            min-h-min bg-[url('../public/pexels-aleksandar-pasaric-2603464-2.jpg')] rounded-3xl h-1/2 w-full bg-no-repeat bg-cover bg-fixed lg:flex-grow">
                <div class=" flex flex-col md:pr-16  md:w-3/4 md:items-start md:text-left mb-16 md:mb-0 lg:pr-24 lg:flex-grow   items-center text-center xl:w-full">
            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="flex flex-wrap w-3/4 h-80 md:w-1/2 2xl:h-80">
                    <iframe className=" w-full h-full" src="https://www.youtube.com/embed/-5KAN9_CzSA" title="coffee shop radio // 24/7 lofi hip-hop beats" alt="YouTube video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
